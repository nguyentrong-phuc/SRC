/*----------------------------------------------
* CHUONG TRINH TEST GOC PITCH CHO DRONE 3KG
...
//	droneData.awez = 1;
  ...
  droneData.awez = 1.1;//1.12;//1.03;
  droneData.mpu_data.gex = -2.5//-1.66;//0.45;//-1.45; -1.1
  droneData.mpu_data.gey= -5.8//-0.7;//0.35;// 0.05; -3.65
  droneData.mpu_data.gez= 4//-1.4;//-0.15;//-1.18; -0.65
