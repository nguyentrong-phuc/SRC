...
void setup()
{
  ...
  //Offset values cho gia toc cho cam bien thay vao ngay 13/12/2024
	droneData.awex = -0.0357;//-0.35/9.81;
	droneData.awey = 0;
	droneData.awez = 0.87;
	droneData.mpu_data.gex = -1.45;
	droneData.mpu_data.gey= 0.05;
 droneData.mpu_data.gez= -1.18;
...
//  Serial.print((drone_in->awx)*10); //Serial.print(", ");
//  Serial.print((drone_in->awy)*10); //Serial.print(", ");
...
void setupAltitudeControl(orcdrone_data *drone_in){
  ...
  drone_in->z_kp = 13;  drone_in->z_ki = 1;   drone_in->z_kd = 6.5;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; 
}