/*----------------------------------------------
* CHUONG TRINH TEST PHUONG Z CUA DRONE TRONG NHA
* Written by Dang Xuan Ba <dang.xuanba@gmail.com>
* Date of version: 2025/01/22
* Hardware: main module (Mega Pro 2560)
* Modified stably in 2025-01-22
* Note: Pmax: = 900
-------------------------------------------------*/
...
//  //  Serial.print(drone_in->pitch_d); Serial.print(", ");
//  
//  // Serial.print(drone_in->ebimu_data.yaw); Serial.print(", ");
//  // Serial.print(drone_in->yaw_d); //Serial.print(", ");
//
////	Serial.print(drone_in->ebimu_data.yaw); Serial.print(", ");
////Serial.print(drone_in->mpu_data.gx); Serial.print(", ");
////Serial.print(drone_in->u_roll); //Serial.print(", ");
//
////Serial.print(drone_in->mpu_data.gy+0*100); //Serial.print(", ");
////Serial.print(drone_in->mpu_data.gz); Serial.print(", ");
////Serial.print(drone_in->mpu_data.accz); Serial.print(", ");
////Serial.print(drone_in->mpu_data.readErrCnt); Serial.print(", ");
...
void setupAltitudeControl(orcdrone_data *drone_in){
  ...
  //drone_in->pitch_kp = 9.5;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 3; drone_in->pitch_ei = 0; //OK DRONE30K
  drone_in->pitch_kp = 10;  drone_in->pitch_ki = 1;   drone_in->pitch_kd = 3; drone_in->pitch_ei = 0; 
...
//  drone_in->pitch_kp = 4;  drone_in->pitch_ki = 0;   drone_in->pitch_kd = 2; drone_in->pitch_ei = 0;
 ...
 //   drone_in->roll_kp = 10;     drone_in->roll_ki = 0.5;    drone_in->roll_kd = 3;  drone_in->roll_ei = 0; //OK DRONE30K

    
  drone_in->roll_kp = 10;     drone_in->roll_ki = 1;    drone_in->roll_kd = 3;  drone_in->roll_ei = 0;
  //drone_in->yaw_kp = 9;    drone_in->yaw_ki = 0.5;     drone_in->yaw_kd = 3;   drone_in->yaw_ei = 0;  //OK DRONE30K
...
//  drone_in->z_kp = 20;  drone_in->z_ki = 1;   drone_in->z_kd = 7;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; 
  drone_in->z_kp = 15;  drone_in->z_ki = 1;   drone_in->z_kd = 4;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; 
