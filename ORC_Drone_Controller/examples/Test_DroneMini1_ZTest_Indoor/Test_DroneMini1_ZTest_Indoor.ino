/*----------------------------------------------
* CHUONG TRINH TEST GOC YAW CHO DRONE 30KG
...
//	droneData.awez = 1;
	...
	// droneData.awex = 0;//-0.08;//-0.04;//-0.0357;//-0.35/9.81;
  // droneData.awey = 0;//-0.0275;
  // droneData.awez = 1.03;//1.12;//1.03;
  // droneData.mpu_data.gex = -1.66;//0.45;//-1.45; -1.1
  // droneData.mpu_data.gey= -0.7;//0.35;// 0.05; -3.65
  // droneData.mpu_data.gez= -1.4;//-0.15;//-1.18; -0.65
...
//Serial.print(drone_in->mpu_data.gz - 0*100); //Serial.print(", ");
...
//   Serial.print(drone_in->obstacleAvoidanceVar.ov_yd);
	//	Serial.print(drone_in->P_basic*0.01); 
  Serial.println()	;
	}
}
/* Cai dat cac thong so dieu khien he thong
...
void setupAltitudeControl(orcdrone_data *drone_in){
 ...
 //  drone_in->pitch_kp = 12;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 3; drone_in->pitch_ei = 0;
  drone_in->pitch_kp = 12;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 3; drone_in->pitch_ei = 0;
...
//  drone_in->yaw_kp = 12;    drone_in->yaw_ki = 0.5;     drone_in->yaw_kd = 3;   drone_in->yaw_ei = 0;
