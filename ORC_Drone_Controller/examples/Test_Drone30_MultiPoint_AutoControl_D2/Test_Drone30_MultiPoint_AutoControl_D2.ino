/*----------------------------------------------
* CHUONG TRINH TEST BAY GPS CUA DRONE 30L
* Written by Dang Xuan Ba <dang.xuanba@gmail.com>
* Date of version: 2025/01/23
* Hardware: main module
* Modified stably in 2025-01-23
-------------------------------------------------*/
...
//  //Offset values cho gia toc cho cam bien thay vao ngay 13/12/2024 30L V1
//	droneData.awex = -0.04;//-0.0357;//-0.35/9.81;
//  droneData.awey = -0.0275;
//  droneData.awez = 1.05;
//  droneData.mpu_data.gex = 0;//0.45;//-1.45; -1.1
//  droneData.mpu_data.gey= 0;//0.35;// 0.05; -3.65
//  droneData.mpu_data.gez= 0;//-0.15;//-1.18; -0.65

  //Offset values cho gia toc cho cam bien thay vao ngay 13/12/2024 30L V2
  droneData.awex = -0.025;//-0.08;//-0.04;//-0.0357;//-0.35/9.81;
  droneData.awey = 0.042;//-0.0275;
  droneData.awez = 1.02;//1.1;//1.03;
  droneData.mpu_data.gex = -1.45;//-2.3;//0.45;//-1.45; -1.1
  droneData.mpu_data.gey= 0;//2.95;//0.35;// 0.05; -3.65
  droneData.mpu_data.gez= -1.55;//-0.8;//-0.15;//-1.18; -0.65
...
//Serial.print(drone_in->mpu_data.gx*10); Serial.print(",, ");
...
//////   Serial.print(drone_in->xd); Serial.print(", ");
//Serial.print(drone_in->gpsdata.pos_cm[0]); Serial.print(", ");
//Serial.print(drone_in->gpsdata.pos_cm[1]); Serial.print(", ");
...
////  Serial.print(drone_in->awz);Serial.print(", ");
//  
...
void setupAltitudeControl(orcdrone_data *drone_in){
   ...
   drone_in->pitch_kp = 11;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 4.5; drone_in->pitch_ei = 0;
//   drone_in->pitch_kp = 12;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 5; drone_in->pitch_ei = 0;
//  drone_in->pitch_kp = 10;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 4.5; drone_in->pitch_ei = 0;
//  drone_in->pitch_kp = 4;  drone_in->pitch_ki = 0;   drone_in->pitch_kd = 2; drone_in->pitch_ei = 0;
//   drone_in->roll_kp = 12;     drone_in->roll_ki = 0.5;    drone_in->roll_kd = 5;  drone_in->roll_ei = 0;
   drone_in->roll_kp = 11;     drone_in->roll_ki = 0.5;    drone_in->roll_kd = 4.5;  drone_in->roll_ei = 0;
//    drone_in->roll_kp = 10;     drone_in->roll_ki = 0.5;    drone_in->roll_kd = 4.5;  drone_in->roll_ei = 0;
//  drone_in->roll_kp = 4;     drone_in->roll_ki = 0;    drone_in->roll_kd = 2;  drone_in->roll_ei = 0;
  //drone_in->yaw_kp = 9.5;    drone_in->yaw_ki = 0.5;     drone_in->yaw_kd = 4.5;   drone_in->yaw_ei = 0;
  drone_in->yaw_kp = 11;    drone_in->yaw_ki = 0.5;     drone_in->yaw_kd = 5;   drone_in->yaw_ei = 0;
...
//   drone_in->z_kp = 17;  drone_in->z_ki = 1;   drone_in->z_kd = 6;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; //DRONE30K --> OK
//  drone_in->z_kp = 16;  drone_in->z_ki = 1;   drone_in->z_kd = 7;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; 
  //drone_in->z_kp = 16;  drone_in->z_ki = 1;   drone_in->z_kd = 7;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; //DRONE30L2 - OK RTK 10HZ: 16, 1, 7.5
  drone_in->z_kp = 16;  drone_in->z_ki = 1;   drone_in->z_kd = 7.7;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; 
