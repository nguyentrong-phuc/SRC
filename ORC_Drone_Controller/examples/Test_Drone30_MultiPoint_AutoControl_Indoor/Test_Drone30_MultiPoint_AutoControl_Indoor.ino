...
void setup()
{
  ...
  droneData.mpu_data.gey= 0.35;// 0.05; -3.65
  droneData.mpu_data.gez= -0.15;//-1.18; -0.65
...
//  Serial.print(drone_in->gpsdata.readErrCnt); //Serial.print(", ");
  if (drone_in->desiredData.flyMode == FLY_MODE_MULTI_POINT){
    for (int i = 0; i<drone_in->desiredData.data_PtoP_Control[0][POINT_MEMORY_INDEX_LEN]; i++){
      Serial.print("( ");Serial.print(i); Serial.print(": ");
      Serial.print(drone_in->desiredData.data_PtoP_Control[i][POINT_MEMORY_INDEX_XD]); Serial.print(", ");
      Serial.print(drone_in->desiredData.data_PtoP_Control[i][POINT_MEMORY_INDEX_YD]); Serial.print(", ");
      Serial.print(drone_in->desiredData.data_PtoP_Control[i][POINT_MEMORY_INDEX_ZD]); Serial.print(", ");
      Serial.print(drone_in->desiredData.data_PtoP_Control[i][POINT_MEMORY_INDEX_TIME]); Serial.print(" ) ");
    }
    Serial.println();
    Serial.print(drone_in->auto_current_point); Serial.print(", ");
    Serial.print(drone_in->x);  Serial.print(", ");
    Serial.print(((float)drone_in->gpsdata.pos_cm[0])/100);  Serial.print(", ");
    Serial.print(drone_in->xd);  Serial.print("| ");
    
    Serial.print(drone_in->y);  Serial.print(", ");
    //Serial.print(((float)drone_in->gpsdata.pos_cm[1])/100);  Serial.print(", ");
    Serial.print(drone_in->yd); Serial.print("| ");
    
    Serial.print(drone_in->z);  Serial.print(", ");
    //Serial.print(((float)drone_in->gpsdata.pos_cm[2])/100);  Serial.print(", ");
    Serial.print(drone_in->zd);  Serial.print("| ");
    
    Serial.print(drone_in->roll_d);  Serial.print(", ");
    Serial.print(drone_in->pitch_d); Serial.println(".");
...
void setupAltitudeControl(orcdrone_data *drone_in){
  ...
  drone_in->pitch_kp = 9.5;  drone_in->pitch_ki = 0.5;   drone_in->pitch_kd = 4; drone_in->pitch_ei = 0;
...
//  drone_in->roll_kp = 4;     drone_in->roll_ki = 0;    drone_in->roll_kd = 2;  drone_in->roll_ei = 0;
  drone_in->yaw_kp = 9;    drone_in->yaw_ki = 0.5;     drone_in->yaw_kd = 4;   drone_in->yaw_ei = 0;
//  drone_in->yaw_kp = 0;    drone_in->yaw_ki = 0;     drone_in->yaw_kd = 0;   drone_in->yaw_ei = 0;
 ...
 // drone_in->y_kp = 0;   drone_in->y_ki = 0;   drone_in->y_kd = 0;   drone_in->y_ei1 = 0; drone_in->y_ei2 = 0;
  ...
  drone_in->z_kp = 17;  drone_in->z_ki = 1;   drone_in->z_kd = 6.5;   drone_in->z_ei1 = 0; drone_in->z_ei2 = 0; 
