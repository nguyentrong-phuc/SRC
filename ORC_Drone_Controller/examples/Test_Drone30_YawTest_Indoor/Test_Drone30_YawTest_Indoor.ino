/*----------------------------------------------
* CHUONG TRINH TEST GOC YAW CUA DRONE
...
//	droneData.awez = 1;
  ...
  droneData.awex = 0.05;//-0.08;//-0.04;//-0.0357;//-0.35/9.81;
  droneData.awey = 0.01;//-0.0275;
  droneData.awez = 1.1;//1.12;//1.03;
  droneData.mpu_data.gex = -2.5;//0.45;//-1.45; -1.1
  droneData.mpu_data.gey= -5.8;//0.35;// 0.05; -3.65
  droneData.mpu_data.gez= 4;//-0.15;//-1.18; -0.65
...
void setupAltitudeControl(orcdrone_data *drone_in){
  ...
  drone_in->pitch_kp = 1;  drone_in->pitch_ki = 0.1;   drone_in->pitch_kd = 0.3; drone_in->pitch_ei = 0; 
...
//  drone_in->pitch_kp = 4;  drone_in->pitch_ki = 0;   drone_in->pitch_kd = 2; drone_in->pitch_ei = 0;
 ...
 //   drone_in->roll_kp = 10;     drone_in->roll_ki = 0.5;    drone_in->roll_kd = 3;  drone_in->roll_ei = 0; //OK DRONE30K
  ...
  drone_in->roll_kp = 1;     drone_in->roll_ki = 0.1;    drone_in->roll_kd = 0.3;  drone_in->roll_ei = 0;
  drone_in->yaw_kp = 9;    drone_in->yaw_ki = 0.5;     drone_in->yaw_kd = 3;   drone_in->yaw_ei = 0;
