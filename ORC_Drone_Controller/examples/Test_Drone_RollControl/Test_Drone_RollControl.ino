...
//  Serial.println(droneData.mpu_data.gx);// Serial.print(", ");
  Serial.println(droneData.desiredData.manual_rolld); 
}

void setupRollControl(orcdrone_data *drone_in){
  drone_in->roll_kp = 12;   drone_in->roll_ki = 0.5;  drone_in->roll_kd = 4.5;  drone_in->roll_ei = 0;
